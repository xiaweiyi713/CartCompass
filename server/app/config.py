...
SPEECH_TRANSCRIPTION_BASE_URL = os.getenv("SPEECH_TRANSCRIPTION_BASE_URL", ARK_BASE_URL)
SPEECH_TRANSCRIPTION_MODEL = os.getenv("SPEECH_TRANSCRIPTION_MODEL", ARK_MODEL)
SPEECH_TRANSCRIPTION_API_KEY = os.getenv("SPEECH_TRANSCRIPTION_API_KEY") or ARK_API_KEY
SPEECH_TRANSCRIPTION_TIMEOUT_SECONDS = float(os.getenv("SPEECH_TRANSCRIPTION_TIMEOUT_SECONDS", "30"))
